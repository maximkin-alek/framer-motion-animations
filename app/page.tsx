    ...
    <main className={styles.main}>
      ...
      <ol>
        <li className={styles.descriptionItem}>
          ...
          разработчиков. Гибкость: Библиотека предоставляет множество
          возможностей для создания различных типов анимаций, включая движение,
          изменение стилей, появление и исчезновение элементов и многое другое.
          Это позволяет реализовывать самые разнообразные идеи.
        </li>
        <li className={styles.descriptionItem}>
